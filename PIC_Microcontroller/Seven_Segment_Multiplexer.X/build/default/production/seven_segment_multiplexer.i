...
# 2 "<built-in>" 2
# 1 "seven_segment_multiplexer.c" 2
...
# 2 "seven_segment_multiplexer.c" 2
...
# 3 "seven_segment_multiplexer.c" 2



unsigned char BCDNum[4];
unsigned int count,val=0;
const char seg_data[]={ 0b11100111,
                        0b00100001,
                        0b11001011,
                        0b01101011,
                        0b00101101,
...
void __attribute__((picinterrupt(("high_priority")))) seg_display(void)
{
