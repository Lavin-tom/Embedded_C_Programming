...
SOURCEFILES_QUOTED_IF_SPACED=../PIC18F_Library/LCD.c ../PIC18F_Library/Keypad.c matrix_keypad.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1771299872/LCD.p1 ${OBJECTDIR}/_ext/1771299872/Keypad.p1 ${OBJECTDIR}/matrix_keypad.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1771299872/LCD.p1.d ${OBJECTDIR}/_ext/1771299872/Keypad.p1.d ${OBJECTDIR}/matrix_keypad.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1771299872/LCD.p1 ${OBJECTDIR}/_ext/1771299872/Keypad.p1 ${OBJECTDIR}/matrix_keypad.p1

# Source Files
SOURCEFILES=../PIC18F_Library/LCD.c ../PIC18F_Library/Keypad.c matrix_keypad.c
...
${DISTDIR}/Keypad.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/Keypad.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -mdebugger=none  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -mrom=4-7000 -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"../PIC18F_Library" -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/Keypad.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} ${DISTDIR}/Keypad.X.${IMAGE_TYPE}.hex 
	
else
${DISTDIR}/Keypad.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/Keypad.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -mrom=4-7000 -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"../PIC18F_Library" -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/Keypad.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
