...
# 2 "<built-in>" 2
# 1 "EEPROM_SPI_main.c" 2


# 1 "../PIC18F_Library\\Config.h" 1
# 16 "../PIC18F_Library\\Config.h"
...
# 3 "EEPROM_SPI_main.c" 2

# 1 "../PIC18F_Library\\LCD.h" 1
# 23 "../PIC18F_Library\\LCD.h"
void LCD_Init(void);
void LCD_Command(unsigned char cmd);
void LCD_Data(unsigned char data);
void LCD_RAM_String(unsigned char *str);
void LCD_ROM_String(const char *str);
# 4 "EEPROM_SPI_main.c" 2
...
# 5 "EEPROM_SPI_main.c" 2
# 17 "EEPROM_SPI_main.c"
void SPI_Init()
{
    SSPCON1bits.SSPM = 0b001;
    SSPCON1bits.CKP = 0;
    SSPSTATbits.SMP = 1;
    SSPSTATbits.CKE = 1;
...
void SPI_EEPROM_writebyte(unsigned int addr, unsigned char data)
{
    ...
    PORTCbits.RC2 = 0;;
    SPI_Read_Write((unsigned)0b00000110);
    PORTCbits.RC2 = 1;;

    _delay((unsigned long)((100)*(20000000/4000000.0)));

    PORTCbits.RC2 = 0;;
    SPI_Read_Write((unsigned)0b00000010);
    ...
    SPI_Read_Write((unsigned)0b00000100);
}
unsigned char SPI_EEPROM_readbyte(unsigned int addr)
{
    ...
    PORTCbits.RC2 = 0;;
    SPI_Read_Write((unsigned)0b00000011);
    SPI_Read_Write(Higher_byte);
    SPI_Read_Write(Lower_byte);

    Read_val = SPI_Read_Write(0xff);
    PORTCbits.RC2 = 1;;
